...
public class SimpleTableModel extends TableModel
{
	...
	public boolean setValueAt(Object a_Object, int ai_row, int ai_column) throws ComponentDataException
	{
		...
		{
			throw new ArrayIndexOutOfBoundsException(
					"Tried to set value to out of column range. Column range is always 1");
		}
	 ...
	 * @param a_Object
	 *            to put end of List
	 * @return number of row if success largen than 0, -1 if error.
	 */
	...
	public String getColumnName(int ai_index)
	{
		...
		{
			throw new ArrayIndexOutOfBoundsException(
					"Tried to getColumnName to out of column range. Column range is always 1");
		}
		return "";
	}
